# Instructions: Determine ASCE 7-22 Site Class from input/result.md

## Purpose

Use this workflow when asked to determine an ASCE 7-22 site class. It tells the assistant how to:

1. read `Vs30` from `input/result.md` in meters per second (m/s),
...
- Input data: [input/result.md](file:///c:/Users/Liang%20Chow/Desktop/Projects/GitHub/sade-geo/input/result.md)
- Reference chapter + Table 20.2-1: [specs/asce_722/ch20.md](file:///c:/Users/Liang%20Chow/Desktop/Projects/GitHub/sade-geo/specs/asce_722/ch20.md)

## Step-by-Step Procedure

### 1. Locate Vs30 in result.md

Open `input/result.md` and find the line that reports Vs30.
...
1. **Vs30 from result.md** (value and unit)
2. **Conversion** (m/s → ft/s with `* 30.48`)
...
6. **Citation references** to:
   - [input/result.md](file:///c:/Users/Liang%20Chow/Desktop/Projects/GitHub/sade-geo/input/result.md)
   - Table 20.2-1 in [specs/asce_722/ch20.md](file:///c:/Users/Liang%20Chow/Desktop/Projects/GitHub/sade-geo/specs/asce_722/ch20.md#L43-L55)

## Example Prompt Template

Use the following instruction when asking the assistant to perform this workflow:

> Determine the ASCE 7-22 Site Class using instructions in specs/asce_722/site_class_from_result_md.md. Read Vs30 from input/result.md in m/s, convert to ft/s by multiplying by 30.48, then look up Table 20.2-1 in specs/asce_722/ch20.md and report the site class with full calculations and file references.

## Example Calculation (for verification only)

If `input/result.md` contains:
...
- cite the Vs30 number directly from [input/result.md](file:///c:/Users/Liang%20Chow/Desktop/Projects/GitHub/sade-geo/input/result.md),
- convert to ft/s using multiplication by `3.28084`,
- match the converted value to the correct row in Table 20.2-1 from [ch20.md](file:///c:/Users/Liang%20Chow/Desktop/Projects/GitHub/sade-geo/specs/asce_722/ch20.md#L43-L55), and
